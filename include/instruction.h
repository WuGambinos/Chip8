 ...
 * opcode: 00EN
 */
void op_0(Chip8* s, uint16_t opcode);
 ...
 *
 */
void op_1(Chip8* s, uint16_t opcode);
 ...
 * opcode: 2NNN
 */
void op_2(Chip8* s, uint16_t opcode);
 ...
 * opcode: 3XNN
 */
void op_3(Chip8* s, uint16_t opcode);
 ...
 * opcode: 4XNN
 */
void op_4(Chip8* s, uint16_t opcode);

/*
 * Function: op_5
 * -------------
 * 5XY0 - Skip if VX == VY
 * Skip next instruction if value in register VX is equal to value in register
 * VY
 *
 * s: pointer to Chip8 struct
 * opcode: 5XY0
 */
void op_5(Chip8* s, uint16_t opcode);
 ...
 * opcode: 6XNN
 */
void op_6(Chip8* s, uint16_t opcode);
 ...
 * opcode: 2NNN
 */
void op_7(Chip8* s, uint16_t opcode);
 ...
 */
void op_8(Chip8* s, uint16_t opcode);

/*
 * Function: op_9
 * -------------
 * 9XY0 - Skip if VX != VY
 * Skips next instruction if the value in register VX doesn't equal the value in
 * register VY
 *
 * s: pointer to Chip8 struct
 * opcode: 9XY0
 */
void op_9(Chip8* s, uint16_t opcode);
 ...
 * opcode: ANNN
 */
void op_a(Chip8* s, uint16_t opcode);
 ...
 * opcode: BNNN
 */
void op_b(Chip8* s, uint16_t opcode);
 ...
 * opcode: CXKK
 */
void op_c(Chip8* s, uint16_t opcode);
 ...
 * opcode: DXYN
 */
void op_d(Chip8* s, uint16_t opcode);
 ...
 * opcode: EXNN
 */
void op_e(Chip8* s, uint16_t opcode);
 ...
 * opcode: FXNN
 */
void op_f(Chip8* s, uint16_t opcode);
